...
// -----------------------------------------------------------------------------------//
{
  ...
  // ---------------------------------------------------------------------------------//
  {
    ...
    cursed = getSignedShort (buffer, offset + 36) != 0;
    ...
    crithitm = getShort (buffer, offset + 74) != 0;       // boolean
  ...
  // ---------------------------------------------------------------------------------//
  {
    ...
    cursed = getSignedShort (buffer, 5) != 0;
    ...
    crithitm = getShort (buffer, 43) != 0;       // boolean
    wepvstyFlags = getShort (buffer, 45);        // purposed

    System.out.printf ("%-15s %d%n", name, getShort (buffer, 43));
  }
